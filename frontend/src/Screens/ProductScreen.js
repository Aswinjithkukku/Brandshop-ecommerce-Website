          ...
          <Row>
            <Col md={6}>
              ...
              {product.reviews.length === 0 && (
                <p className="text-info">No Reviews</p>
              )}
              <ListGroup variant="flush">
                ...
                <ListGroup.Item>
                  ...
                  {successProductReview && <p className="text-success">Review Submitted</p>}
                  {errorProductReview && <h5 className="text-danger"> {errorProductReview} </h5>}

                  {userInfo ? (
                    <Form onSubmit={submitHandler}>
                      <Form.Group controlId="rating" className="mt-1">
